...
function ACL {
	mkdir -p /usr/local/mysql8015/{runtime,data,temp,log/innodb}
...
LimitNOFILE = 5000' > /usr/lib/systemd/system/mysqld.service
	# 設置開機自啟	
